...
export const ImportVoucherInfoCard = ({ id }: ImportVoucherInfoCardProps) => {
    const [voucher, setVoucher] = useState<ImportVoucherResponse | null>(null)
            ...
            <CardContent className="pt-8 space-y-8">
                ...
                <div className="space-y-4">
                    <h3 className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
                        <ClipboardList className="h-5 w-5" /> Procured Equipment ({voucher.details.length})
                    </h3>
