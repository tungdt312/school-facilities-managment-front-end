...
import { Pencil, Save, X, Loader2, Mail, ShieldCheck, User } from 'lucide-react'
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="flex flex-col gap-8 md:flex-row md:items-start">
                            ...
                            {/* Left: Avatar Section */}
                            <div className="flex flex-col items-center gap-4 md:w-1/3 border-b md:border-b-0 md:border-r pb-6 md:pb-0 md:pr-6">
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value} disabled={!isEditing}>
                                                    <FormControl>
                                                        <SelectTrigger className={!isEditing ? "bg-muted/50 border-transparent cursor-not-allowed" : "bg-background"}>
