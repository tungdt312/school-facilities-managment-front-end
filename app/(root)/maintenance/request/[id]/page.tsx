            ...
            <div className="flex flex-1 flex-col">
                <div className="@container/main flex flex-1 flex-col gap-2">
                    <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-6">
                        <MaintenanceRequestDetail id={id} />
                    </div>
                </div>
            </div>
        </>
            ...
            <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator/>
                        <BreadcrumbItem>
                            <BreadcrumbLink href={"/maintenance/request"}>Request</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator/>
                        <BreadcrumbItem>
                            <BreadcrumbLink href={`/maintenance/request/${id}`}>Detail [{id}] </BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
